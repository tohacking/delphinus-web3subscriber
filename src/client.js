...
exports.withDelphinusWalletConnector = exports.withReadOnlyConnector = exports.withBrowserConnector = exports.DelphinusContract = void 0;
...
function withBrowserConnector(cb) {
    return __awaiter(this, void 0, void 0, function* () {
        let provider = new provider_1.DelphinusBrowserConnector();
        try {
...
exports.withBrowserConnector = withBrowserConnector;
// For read-only purposes without private key, we can use a provider to read the blockchain state
function withReadOnlyConnector(cb, providerUrl) {
    return __awaiter(this, void 0, void 0, function* () {
        let provider = new provider_1.DelphinusReadOnlyConnector(providerUrl);
        try {
            return yield cb(provider);
        }
        catch (e) {
...
exports.withReadOnlyConnector = withReadOnlyConnector;
...
function withDelphinusWalletConnector(cb, provider, privateKey) {
    return __awaiter(this, void 0, void 0, function* () {
        let wallet = new provider_1.DelphinusWalletConnector(privateKey, provider);
        try {
...
exports.withDelphinusWalletConnector = withDelphinusWalletConnector;
